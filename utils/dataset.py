...
def get_train_val_dataloader_t1(root_dir : str, batch_size : int = 16):
    ...
    # Define data loaders
    train_loader = DataLoader(train_val_dataset, batch_size=batch_size, sampler=train_sampler,shuffle=True)
    val_loader = DataLoader(train_val_dataset, batch_size=batch_size, sampler=val_sampler,shuffle=True)
...
if __name__=="__main__":
    root_dir = '/media/saitomar/Work/Projects/DeepLense_Test/task_1_dataset/dataset/train'
